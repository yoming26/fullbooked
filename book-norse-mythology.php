					...
					<div class="col-lg-8 d-none d-lg-block">
						<nav class="mainmenu__nav">
							<ul class="meninmenu d-flex justify-content-start">
								...
								<li class="drop"><a href="shop-grid.phpss">Books</a>
									<div class="megamenu mega03">
										<ul class="item item03">
											<li class="title">Categories</li>
											<li><a href="shop-grid.phpss">Biography </a></li>
											<li><a href="shop-grid.phpss">Business </a></li>
											<li><a href="shop-grid.phpss">Cookbooks </a></li>
											<li><a href="shop-grid.phpss">Health & Fitness </a></li>
											<li><a href="shop-grid.phpss">History </a></li>
										</ul>
										<ul class="item item03">
											<li class="title">Customer Favourite</li>
											<li><a href="shop-grid.phpss">Mystery</a></li>
											<li><a href="shop-grid.phpss">Religion & Inspiration</a></li>
											<li><a href="shop-grid.phpss">Romance</a></li>
											<li><a href="shop-grid.phpss">Fiction/Fantasy</a></li>
											<li><a href="shop-grid.phpss">Sleeveless</a></li>
										</ul>
										<ul class="item item03">
											<li class="title">Collections</li>
											<li><a href="shop-grid.phpss">Science </a></li>
											<li><a href="shop-grid.phpss">Fiction/Fantasy</a></li>
											<li><a href="shop-grid.phpss">Self-Improvemen</a></li>
											<li><a href="shop-grid.phpss">Home & Garden</a></li>
											<li><a href="shop-grid.phpss">Humor Books</a></li>
										</ul>
									</div>
								</li>
								
								<li><a href="about.phpss">About Us</a>
									
								</li>
								<li><a href="contact.phpss">Contact Us</a></li>
							</ul>
						</nav>
					</div>
								...
								<div class="block-minicart minicart__active">
									<div class="minicart-content-wrapper">
										...
										<div class="mini_action checkout">
											<a class="checkout__btn" href="cart.phpss">Go to Checkout</a>
										</div>
										<div class="single__items">
											<div class="miniproduct">
												<div class="item01 d-flex">
													<div class="thumb">
														<a href="product-details.phpss"><img
																src="im\22.jpg"
																alt="product images"></a>
													</div>
													<div class="content">
														<h6><a href="product-details.phpss">Voyage Yoga Bag</a></h6>
												...
												<div class="item01 d-flex mt--20">
													...
													<div class="content">
														<h6><a href="product-details.phpss">Impulse Duffle</a></h6>
												...
												<div class="item01 d-flex mt--20">
													...
													<div class="content">
														<h6><a href="product-details.phpss">Compete Track Tote</a></h6>
														<span class="prize">&#8369;100.00</span>
														<div class="product_prize d-flex justify-content-between">
															<span class="qun">Qty: 03</span>
															<ul class="d-flex justify-content-end">
										...
										<div class="mini_action cart">
											<a class="cart__btn" href="cart.phpss">View and edit cart</a>
										</div>
									</div>
								</div>
								<!-- End Shopping Cart -->
								...
								<div class="col-lg-6 col-12">
									<div class="wn__fotorama__wrapper">
										<div class="fotorama wn__fotorama__action" data-nav="thumbs">
											<a href="book-norse-mythology.phpss"><img src="im\3.jpg" alt=""></a>
											<a href="the-testament.phpss"><img src="im\1.jpg" alt=""></a>
											<a href="book-smashed.phpss.jpg"><img src="im\2.jpg" alt=""></a>
											<a href="4.jpg"><img src="im\4.jpg" alt=""></a>
											<a href="5.jpg"><img src="im\5.jpg" alt=""></a>
											<a href="6.jpg"><img src="im\6.jpg" alt=""></a>
											<a href="how-to.phpss"><img src="im\7.jpg" alt=""></a>
											<a href="8.jpg"><img src="im\8.jpg" alt=""></a>
										</div>
									</div>
								</div>
								<div class="col-lg-6 col-12">
									<div class="product__info__main">
										...
										<div class="product__overview">
											<p>Norse mythology is the body of myths of the North Germanic peoples, stemming from Norse paganism and continuing after the Christianization of Scandinavia, and into the Scandinavian folklore of the modern period. </p>
							...
							<div class="tab__container">
								...
								<div class="pro__tab_label tab-pane fade show active" id="nav-details" role="tabpanel">
									<div class="description__attribute">
										<p><strong>Neil Gaiman, long inspired by ancient mythology in creating the fantastical realms of his fiction, presents a bravura rendition of the Norse gods and their world from their origin though their upheaval in Ragnarok.</strong></p>
									...
									<div class="review__attribute">
										...
										<div class="review__ratings__type d-flex">
											...
											<div class="review-content">
												<p>Marlom</p>
												<p>Review by Marlon</p>
												<p>Posted on 11/7/1019</p>
											</div>
										</div>
									</div>
									<div class="review-fieldset">
										<h2>You're reviewing:</h2>
										<h3>Norse Myhtology</h3>
							...
							<div class="row mt--60">
								<div class="productcategory__slide--2 arrows_style owl-carousel owl-theme">
									...
									<div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
										<div class="product__thumb">
											<a class="first__img" href="single-product.phpss"><img
													src="im\1.jpg" alt="product image"></a>
											<a class="second__img animation1" href="single-product.phpss"><img
													src="im\2.jpg" alt="product image"></a>
											<div class="hot__box">
												<span class="hot-label">BEST SALLER</span>
											</div>
										</div>
										<div class="product__content content--center p-3">
											<h4>The Testament</h4>
											<ul class="prize d-flex">
												<li>&#8369;1,214.00</li>
								<li class="old_prize">&#8369;1,400.00</li>
											</ul>
											<div class="action">
												<div class="actions_inner">
													<ul class="add_to_links">
														<li><a class="cart" href="cart.phpss"><i
																	class="bi bi-shopping-bag4"></i></a></li>
														<li><a class="compare" href="wishlist.phpss"><i
									...
									<div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
										<div class="product__thumb">
											...
											<a class="second__img animation1" href="single-product.phpss"><img src="im\3.jpg" alt="product image"></a>
											<div class="hot__box color--2">
												<span class="hot-label">HOT</span>
											</div>
										</div>
										<div class="product__content content--center">
											<h4><a href="book-norse-mythology.phpss">Norse Mythology</a></h4>
											<ul class="prize d-flex">
												<li>&#8369;650.00</li>
								<li class="old_prize">&#8369;700.00</li>
									...
									<div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
										...
										<div class="product__content content--center">
											<h4><a href="single-product.phpss">Mythology</a></h4>
											<ul class="prize d-flex">
												<li>&#8369;599.00</li>
								<li class="old_prize">&#8369;700.00</li>
											</ul>
									...
									<div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
										...
										<div class="product__content content--center">
											<h4><a href="single-product.phpss">The Life Changing Magic of Not giving a F*ck</a></h4>
											<ul class="prize d-flex">
												<li>&#8369;599.00</li>
								<li class="old_prize">&#8369;700.00</li>
											</ul>
									...
									<div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
										...
										<div class="product__content content--center content--center">
											<h4><a href="single-product.phpss">The Beautiful</a></h4>
											<ul class="prize d-flex">
												<li>&#8369;599.00</li>
								<li class="old_prize">&#8369;700.00</li>
											</ul>
							...
							<div class="row mt--60">
								<div class="productcategory__slide--2 arrows_style owl-carousel owl-theme">
									...
									<div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
										...
										<div class="product__content content--center">
											<h4><a href="single-product.phpss">Virgia Woolf</a></h4>
											<ul class="prize d-flex">
												<li>&#8369;599.00</li>
								<li class="old_prize">&#8369;700.00</li>
											</ul>
									...
									<div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
										<div class="product__thumb">
											<a class="first__img" href="single-product.phpss"><img
													src="im\25.jpg" alt="product image"></a>
											<a class="second__img animation1" href="single-product.phpss"><img
													src="im\26.jpg" alt="product image"></a>
											<div class="hot__box color--2">
												<span class="hot-label">HOT</span>
											</div>
										</div>
										<div class="product__content content--center">
											<h4><a href="single-product.phpss">The Literature Book</a></h4>
											<ul class="prize d-flex">
												<li>&#8369;599.00</li>
								<li class="old_prize">&#8369;700.00</li>
											</ul>
									...
									<div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
										<div class="product__thumb">
											<a class="first__img" href="single-product.phpss"><img
													src="im\27.jpg" alt="product image"></a>
											<a class="second__img animation1" href="single-product.phpss"><img
													src="im\28.jpg" alt="product image"></a>
											<div class="hot__box">
												<span class="hot-label">HOT</span>
											</div>
										</div>
										<div class="product__content content--center">
											<h4><a href="single-product.phpss">The History Book</a></h4>
											<ul class="prize d-flex">
												<li>&#8369;599.00</li>
								<li class="old_prize">&#8369;700.00</li>
											</ul>
									...
									<div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
										<div class="product__thumb">
											<a class="first__img" href="single-product.phpss"><img
													src="im\29.jpg" alt="product image"></a>
											<a class="second__img animation1" href="single-product.phpss"><img
													src="im\30.jpg" alt="product image"></a>
											<div class="hot__box">
												<span class="hot-label">HOT</span>
											</div>
										</div>
										<div class="product__content content--center">
											<h4><a href="single-product.phpss">The Shining</a></h4>
											<ul class="prize d-flex">
												<li>&#8369;599.00</li>
								<li class="old_prize">&#8369;700.00</li>
											</ul>
									...
									<div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
										...
										<div class="product__content content--center content--center">
											<h4><a href="single-product.phpss">Tower of Dawn</a></h4>
											<ul class="prize d-flex">
												<li>&#8369;599.00</li>
								<li class="old_prize">&#8369;700.00</li>
											</ul>
									...
									<div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
										...
										<div class="product__content content--center content--center">
											<h4><a href="single-product.phpss">Queen Of Shadows</a></h4>
											<ul class="prize d-flex">
												<li>&#8369;599.00</li>
								<li class="old_prize">&#8369;700.00</li>
											</ul>
